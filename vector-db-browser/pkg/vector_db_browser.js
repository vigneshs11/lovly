...
export class VectorStore {
    ...
    constructor() {
        const ret = wasm.vectorstore_new();
    ...
    search(query, top_k) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vectorstore_search(this.__wbg_ptr, ptr0, len0, top_k);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('vector_db_browser_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
